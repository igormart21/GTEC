      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 min-h-[80vh] sm:min-h-screen flex items-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            >
              Agende sua{' '}
              <span className="text-primary-gold">Visita Técnica</span>{' '}
              gratuita agora
            </motion.h1>
            ...
            >
              e garanta <span className="text-primary-gold font-bold">10% de desconto</span> no seu primeiro atendimento
            </motion.p>
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="text-center">
                <div className="w-24 h-24 bg-primary-gold rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <div className="bg-primary-red text-white px-6 py-3 rounded-lg font-semibold">
                  (14) 99765-5340
                </div>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-4 w-16 h-16 bg-primary-gold rounded-full flex items-center justify-center opacity-90 shadow-lg"
            >
